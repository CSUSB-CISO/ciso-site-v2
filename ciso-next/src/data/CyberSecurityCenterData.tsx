...
export const cyberSecurityCenterMembers = [
    {
        pic: "/assets/cybersecuritycenter_pics/tonycoulson.png",
        subtitle: "Executive Director",
        title: "Dr. Tony Coulson",
        description: "Tony Coulson\n" +
            "\n" +
    ...
    {
        pic: "/assets/cybersecuritycenter_pics/rouse.png",
        subtitle: "Community College Cyber Pilot Program Manager",
        title: "Charles Rouse",
        description: "Charles Rouse\n" +
            "\n" +
            "Charles Rouse is the Community College Cyber Pilot (C3P) program manager for the Cybersecurity Center in the Jack H. Brown College of Business and Public Administration at California State University, San Bernardino (CSUSB). His appointment is a new department position, commissioned by the National Science Foundation to support the CyberCorps: Scholarship for Service (SFS) program extension to community colleges across the Nation.\n" +
            "\n" +
    ...
    },
    {
        ...
        description: "Robin Robertson\n" +
            "\n" +
            "Robin Robertson has been the Administrative Assistant for the Cybersecurity Center for the past 8 years. In her role, she works closely with both Cybersecurity staff and students in our CyberCorps: Scholarship for Service (SFS) program. Robin handles the financial resources and professional development activities our SFS students require for successful completion of the program.\n" +
            "\n" +
